...
function theme_options_do_page() {
  ...
  <div class="wrap">
    ...
    <p>Feel free to contact me via email <a href="mailto:colortype.wordpress@zihua.li">colortype.wordpress@zihua.li</a> if you have any questions or suggestions about this themes.</p>
  </div>
  <?php
  }
